...
Recall that the peek function let's you peek at a value in the data structure without permanently removing it.  
...
(2) If other code in application changes, recompiling may be necessary.  
...
Slide 11 Solution: In Liger, override the common method, and have it explitcitly call one of the default methods:
...
Slide 12 "and this is a slightly different issue" where Lion is a class and tiger is an interface.