...
So we don't have to traverse the whole list like we do a list in order to move everything over. 
...
First, I suggest attempting to write this code from scratch until you got it then feel free to attempt the following problems. 
