...
<F>
Remember in algebra where we had to solve systems of linear equations? Which was just a fancy way of saying 'find where the lines intersect.'.
</F> 
...
**In fact, our ultimate goal is to get every matrix we work with into RREF because we'll be able to extract the solutions faster.**
