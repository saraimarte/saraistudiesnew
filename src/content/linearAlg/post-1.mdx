...
Now that we're familiar with REF and RREF and know that our goal is to get the matrix in RREF, the question is: How can I get the matrix in those forms? I know what it needs to look like but *how* do I get matricies to look like that? 

Well there are algorithms (recipies) that we can follow that get us to those forms (which we will talk about later) but what tools can we use to follow those recipies?
