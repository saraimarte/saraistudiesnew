...
Think of the string literal as a short hand to construct an object.

This is ONLY true for string literals because the `String` object is built into java and...it's an _abstract_ object.

<DropDown title = "Why is this only true for objects that are abstract and built into Java?">
...
<Code lang="java" fileName="fileName.java" code={
`String name = "name"; //uppercase string = abstract object`}/>
...
variable simply just refers to the new object you just created, it is NOT the
...
<DropDown title = "What's the difference between String.equals(), String.compareTo() and String.equalsIgnoreCase()?">
...
**3.** Given any string, output how frequently a certain character shows up.

<Solution>
<Code lang="java" fileName="fileName.java" code={
`//Given any string, output how frequently a certain character shows up.
