...
public static int subtract(int num1, int num2){ //take in the two numbers, num1 = 5, num2 = 3 num2 is how many times we have to subtract 1 from num1 (5)
    ...
    if (num2 == 0){
        ...
        return subtract(num1, num2-1) - 1; //for every time we subtract 1, well subtract 1 + whatever many - 1 we need to subtract. How do we know how many -1 we need to do? Well num2 tells us how many. 3!
