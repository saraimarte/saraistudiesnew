...
Tables(think of excel): can store less data, does not scale well, does not hold data integrity (you can put a name in for a value that's supposed to be an age.)
